...
async function main() {
  ...
  console.log("==================================================");
  console.log(`TOTAL NULLABILITY MISMATCHES FOUND: ${nullabilityMismatches.length}`);
  console.log(`TOTAL PK MISMATCHES FOUND: ${pkMismatches.length}`);
  console.log("==================================================");

  fs.writeFileSync(
    path.resolve(rootDir, "scratch/nullability_audit_results.json"),
