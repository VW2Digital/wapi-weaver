...
const PROFILING_QUESTIONS = [
  {
    ...
    context:
      "Think about the last few times you asked OpenCode to build or change something. How did you frame the request?",
    question:
      "When you ask OpenCode to build something, how much context do you typically provide?",
    options: [
      {
  ...
  },
  {
    ...
    context:
      "Think about times when OpenCode presented you with multiple options -- like choosing a library, picking an architecture, or selecting an approach.",
    ...
    options: [
      ...
      {
        label: "Let OpenCode recommend -- I generally trust the suggestion",
        value: "d",
        rating: "delegator",
      },
    ],
  },
  {
    ...
    context:
      "Think about when OpenCode explains code it wrote or an approach it took. How much detail feels right?",
  ...
  },
  {
    ...
    context:
      "Think about the last few times something broke in your code. How did you approach it with OpenCode?",
    ...
    options: [
      ...
      {
        label: "Share the error plus context, ask OpenCode to diagnose what went wrong",
        value: "b",
        rating: "diagnostic",
      },
      {
        label: "Investigate myself first, then ask OpenCode about my specific theories",
        value: "c",
  ...
  },
  {
    ...
    options: [
      {
        label: "Use whatever OpenCode suggests -- speed matters more than the perfect choice",
        value: "a",
