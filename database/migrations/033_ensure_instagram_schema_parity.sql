-- ignore-errors
-- 033_ensure_instagram_schema_parity.sql
-- Ensures tenant_id column exists on instagram_accounts and instagram_webhook_events
-- Idempotent for all environments (Fresh installs and existing VPS databases)
...
UPDATE instagram_accounts SET tenant_id = user_id WHERE (tenant_id IS NULL OR tenant_id = '') AND user_id IS NOT NULL;
