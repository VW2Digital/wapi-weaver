        ...
        <Card className="mt-8 space-y-6 p-8">
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
              <li>
                <strong>Informações de conta:</strong> nome, e-mail, telefone e dados de
                autenticação fornecidos durante o cadastro.
              </li>
              <li>
                <strong>Configurações do WhatsApp:</strong> token de acesso e ID do número de
                telefone da Meta que você configura em nossa plataforma.
              </li>
              <li>
                <strong>Contatos:</strong> nomes e números de telefone importados ou sincronizados
                manualmente por você.
              </li>
              <li>
                <strong>Dados de uso:</strong> logs de envio, status de entrega, campanhas criadas e
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
              ...
              <li>
                Enviar notificações importantes sobre sua conta, campanhas ou alterações nos
                serviços.
              </li>
              <li>
                Melhorar nossos serviços, corrigir bugs e desenvolver novas funcionalidades com base
                no uso.
              </li>
              <li>
                Cumprir obrigações legais e regulatórias, incluindo LGPD e outras legislações
                aplicáveis.
              </li>
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              Utilizamos cookies essenciais para manter sua sessão de login e garantir a segurança
              da plataforma. Não utilizamos cookies de rastreamento para publicidade. Você pode
              gerenciar cookies nas configurações do seu navegador, mas isso pode afetar a
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
              <li>
                <strong>Meta (Facebook):</strong> necessário para o funcionamento da WhatsApp Cloud
                API — números de destino e conteúdo de mensagens são processados pela Meta.
              </li>
              <li>
                <strong>Provedores de infraestrutura:</strong> serviços de hospedagem e banco de
                dados que mantêm a plataforma operacional.
              </li>
              <li>
                <strong>Autoridades competentes:</strong> quando exigido por lei, ordem judicial ou
                regulador.
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              Mantemos seus dados pessoais pelo tempo necessário para cumprir os propósitos
              descritos nesta política, ou pelo período exigido por lei. Logs de envio de mensagens
              são retidos por até 2 anos para fins de auditoria e conformidade. Após o encerramento
              da conta, seus dados são excluídos ou anonimizados conforme descrito em nossa{" "}
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              criptografia em trânsito (TLS), controle de acesso baseado em função (RLS),
              autenticação segura e monitoramento contínuo. Apesar dos nossos esforços, nenhum
              sistema é 100% seguro. Em caso de violação de dados, notificaremos os usuários e
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              Para exercer esses direitos, acesse as{" "}
              <Link to="/data-deletion" className="text-primary hover:underline">
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              Você pode solicitar a exclusão completa da sua conta e todos os dados associados a
              qualquer momento. Consulte nossa página dedicada de{" "}
              <Link to="/data-deletion" className="text-primary hover:underline">
                Exclusão de Dados do Usuário
              </Link>{" "}
              para mais detalhes sobre o processo e os prazos.
            </p>
          </section>
