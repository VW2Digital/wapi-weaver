...
// import the function directly or simulate it for the unit test
// since verifySignature is not exported in whatsapp-webhook.ts, we'll recreate the exact logic here 
// to prove it works as intended in the isolated unit.
